...
System.out.println(notification.getRequireInteraction()); // => false
System.out.println(notification.getSilent()); // => false
System.out.println(notification.getUrgent()); // => false
